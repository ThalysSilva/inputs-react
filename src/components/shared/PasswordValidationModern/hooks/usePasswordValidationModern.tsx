...
export function usePasswordValidationModern() {
  ...
  const moreThanEightFunctionValidation = (string: string) =>
    validateStringMinLength(8, string);
  ...
  const minimumOneLetterLowerCaseFunctionValidation = (string: string) =>
    validateRegex(
      string,
      lowercaseRegex,
      passwordValidation.minimumOneLetterLowerCase
    );
  ...
  const minimumOneLetterUpperCaseFunctionValidation = (string: string) =>
    validateRegex(
      string,
      uppercaseRegex,
      passwordValidation.minimumOneLetterUpperCase
    );
  ...
  const lessThanTreeSequentialDigitsFunctionValidation = (string: string) =>
    validateNotContainRegex(
      string,
      sequencialNumbersRegex,
      passwordValidation.lessThanTreeSequentialDigits
    );

  const lessThanTreeSequentialCharacterUpperCaseFunctionValidation = (
    string: string
  ) =>
    validateNotContainRegex(
      string,
  ...
  const lessThanTreeSequentialCharacterLowerCaseFunctionValidation = (
    string: string
  ) =>
    validateNotContainRegex(
      string,
  ...
  const lessThanTreeSequentialCharacterFunctionValidationArray =
  ...
  const lessThanTreeSequentialCharacterFunctionValidation = (string: string) =>
    multipleValidate(
      string,
      lessThanTreeSequentialCharacterFunctionValidationArray
    );
